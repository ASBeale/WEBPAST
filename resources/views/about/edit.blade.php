                  ...
                  <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-1">
                      <div class="mt-1 space-y-6">
                        ...
                        <div class="w-full">
                            ...
                            <div class="mt-2">
                                <input type="text" name="title" id="title" 
                                    ...
                                    value="{{ old('title', $about->title) }}" autofocus>
                            </div>
                            @error('title')
                        ...
                        {{-- input gambar --}}
                        <div class="w-full">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="image">Foto About</label>
                            {{-- untuk mengirimkan data gambar lama --}}
                            <input type="hidden" name="oldImage" value="{{ $about->image }}">
                            @if ($about->image)
                                <img src="{{ asset('/storage/' . $about->image) }}" class="img-preview w-full h-auto mb-3 max-w-xs">
                            @else
                        ...
                        <div class="w-full">
                            ...
                            <div class="mt-2">
                                ...
                                @error('body') is-invalid @enderror">{{ old('body', $about->body) }}</textarea>
                            </div>
                            @error('body')
                                <div class="mt-2 p-4 text-sm text-red-800 rounded-lg bg-red-50" role="alert">
                                    <span class="font-medium">{{ $message }}</span>
