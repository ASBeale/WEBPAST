...
<body>
    ...
    <main class="p-4 md:ml-64 h-auto pt-7 bg-white">
        ...
        <div class="text-center mb-4">
            ...
            <p class="mt-2 text-sm leading-6 text-gray-600">Jadwal Kegiatan Bertugas PAST</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    <form action="{{ route('jadwalkegiatan.index') }}" method="GET" class="max-w-lg">
                        <div class="flex">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 border">{{ $jadwalkegiatan->judul_kegiatan }}</td>
                            <td class="px-4 py-3 border">{{ $jadwalkegiatan->jeniskegiatan->jenis_kegiatan }}</td>
                            <td class="px-4 py-3 border">{{ \Carbon\Carbon::parse($jadwalkegiatan->tanggal_jam_mulai_kegiatan)->format('d M Y (H:i)')}}</td>
                            <td class="px-4 py-3 border">{{ \Carbon\Carbon::parse($jadwalkegiatan->tanggal_jam_selesai_kegiatan)->format('d M Y (H:i)')}}</td>
                            
                            
                            <td class="px-4 py-3 flex items-center justify-center">
                                <button id="apple-imac-27-dropdown-button" data-dropdown-toggle="{{ $jadwalkegiatan->jadwalKegiatanID }}" class="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                    </svg>
                                </button>
                                <div id="{{ $jadwalkegiatan->jadwalKegiatanID }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                        <li>
                                            <a href="/jadwalkegiatan/{{ $jadwalkegiatan->jadwalKegiatanID }}/edit" >
                                        ...
                                        <li>
                                            <a href="/jadwalkegiatan/{{ $jadwalkegiatan->jadwalKegiatanID }}" >
                                        ...
                                        <li>
                                            <form action="/jadwalkegiatan/{{ $jadwalkegiatan->jadwalKegiatanID }}" method="post">
                                                @method('delete')
                                                @csrf
