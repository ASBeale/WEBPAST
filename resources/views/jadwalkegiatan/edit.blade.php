    ...
    <body>
        ...
        <main class="p-4 md:ml-64 h-auto pt-10">
            ...
            <form method="post" action="/jadwalkegiatan/{{ $jadwalkegiatan->jadwalKegiatanID }}">
              @method('put')
                @csrf
                <div class="space-y-12">
                  ...
                  <div class="border-b border-gray-900/10 pb-12">
                    <div class="text-center mb-4">
                        ...
                        <p class="mt-2 text-sm leading-6 text-gray-600">Edit Jadwal Kegiatan Bertugas PAST</p>
                    </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="mt-2">
                                <input type="text" name="judul_kegiatan" id="judul_kegiatan" 
                                    ...
                                    value="{{ old('judul_kegiatan', $jadwalkegiatan->judul_kegiatan) }}" autofocus>
                            </div>
                            ...
                            <select name="jenisKegiatanID" id="jenisKegiatanID" 
                                ...
                                @foreach ($jeniskegiatans as $jeniskegiatan)
                                    <option value="{{ $jeniskegiatan->jenisKegiatanID }}"
                                        {{ old('jenisKegiatanID', $jadwalkegiatan->jenisKegiatanID) == $jeniskegiatan->jenisKegiatanID ? 'selected' : '' }}>
                         ...
                         <div class="w-full">
                            ...
                            <div class="mt-2">
                                <input type="datetime-local" name="tanggal_jam_mulai_kegiatan" id="tanggal_jam_mulai_kegiatan" 
                                    ...
                                    value="{{ old('tanggal_jam_mulai_kegiatan', $jadwalkegiatan->tanggal_jam_mulai_kegiatan) }}">
                            </div>
                         ...
                         <div class="w-full">
                            ...
                            <div class="mt-2">
                                <input type="datetime-local" name="tanggal_jam_selesai_kegiatan" id="tanggal_jam_selesai_kegiatan" 
                                    ...
                                    value="{{ old('tanggal_jam_selesai_kegiatan', $jadwalkegiatan->tanggal_jam_selesai_kegiatan) }}">
                            </div>
