...
<head>
    ...
    <title>Admin PAST - Edit Kehadiran Misa</title>
</head>
<body>
    <x-sidebar-admin></x-sidebar-admin>

    <main class="p-4 md:ml-64 h-auto pt-7">
        <form method="post" action="/kehadiranmisa/{{ $kehadiranMisa->kehadiranMisaID }}">
            @method('put')
            @csrf
                                                ...
                                                <select name="status_kehadiran[]" class="mt-2 w-1/3 rounded-md border border-gray-300 py-1.5 px-3 text-sm">
                                                    @php
                                                        $existingKehadiran = $kehadiranMisa->kehadiranMisaAnggota
                                                            ...
                                                            ->first();
                                                    @endphp
                                                    <option value="" disabled {{ $existingKehadiran && $existingKehadiran->status_kehadiran == '' ? 'selected' : '' }}>Pilih Status</option>
