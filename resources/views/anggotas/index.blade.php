...
<body>
    ...
    <main class="p-4 md:ml-64 h-auto pt-7 bg-white">
        ...
        <div class="text-center mb-4">
            ...
            <p class="mt-2 text-sm leading-6 text-gray-600">List Anggota Putra Altar Santo Tarsisius</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    ...
                    <form action="{{ route('anggotas.index') }}" method="GET" class="max-w-lg">
                        <div class="flex">
                            ...
                            <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                                    <li class="flex items-center px-4 py-2">
                                        <input id="semua" type="radio" name="status" value=""
                                    ...
                                    <li class="flex items-center px-4 py-2">
                                        <input id="aktif" type="radio" name="status" value="1"
                                    ...
                                    <li class="flex items-center px-4 py-2">
                                        <input id="tidak_aktif" type="radio" name="status" value="0"
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3 border">Status Anggota</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 border">{{ $anggota->status_anggota == 1 ? 'Aktif' : 'Tidak Aktif' }}</td>
                            ...
                            <td class="px-4 py-3 flex items-center justify-center">
                                ...
                                <div id="{{ $anggota->anggotaID }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                        ...
                                        <li>
                                            <a href="{{ route('anggotas.show', $anggota->anggotaID) }}" >
