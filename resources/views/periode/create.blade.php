                ...
                <div class="space-y-12">
                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        <div class="text-center mb-4">
                            ...
                            <p class="mt-2 text-sm leading-6 text-gray-600">Penambahan Periode Putra Altar Santo Tarsisius</p>
                        </div>      
                        ...
                        <div class="w-full">
                            ...
                            <div class="mt-2">
                                <input type="text" name="nama_periode" id="nama_periode" 
                                    ...
                                    value="{{ old('nama_periode') }}" autofocus>
                            </div>
                            @error('nama_periode')
                        ...
                        <div class="w-full">
                            ...
                            <div class="mt-2">
                                <input type="date" name="tanggal_selesai_periode" id="tanggal_selesai_periode" 
                                    ...
                                    value="{{ old('tanggal_selesai_periode') }}">
                            </div>
