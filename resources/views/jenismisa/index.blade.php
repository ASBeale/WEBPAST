...
<body>
    ...
    <main class="p-4 md:ml-64 h-auto pt-7 bg-white">
        ...
        <div class="text-center mb-4">
            ...
            <p class="mt-2 text-sm leading-6 text-gray-600">List Jenis Misa bertugas PAST</p>
        </div>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 border">{{ $jenismisa->jenis_misa}}</td>
                            <td class="px-4 py-3 border">{{ $jenismisa->created_at }}</td>
                            
                            <td class="px-4 py-3 flex items-center justify-center">
                                <button id="apple-imac-27-dropdown-button" data-dropdown-toggle="{{ $jenismisa->jenisMisaID }}" class="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                    </svg>
                                </button>
                                <div id="{{ $jenismisa->jenisMisaID }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                        <li>
                                            <a href="/jenismisa/{{ $jenismisa->jenisMisaID }}/edit" >
                                        ...
                                        <li>
                                            <form action="/jenismisa/{{ $jenismisa->jenisMisaID }}" method="post">
                                                @method('delete')
                                                @csrf
