    ...
    <body>
        ...
        <main class="p-4 md:ml-64 h-auto pt-10">
            <form method="post" action="/informations" enctype="multipart/form-data">
                @csrf
                <div class="space-y-12">
                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        <div class="text-center mb-4">
                            ...
                            <p class="mt-2 text-sm leading-6 text-gray-600">Tambah Informasi seputar Putra Altar Santo Tarsisius</p>
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="mt-2">
                                <input type="text" name="slug" id="slug" 
                                    ...
                                    value="{{ old('slug') }}" autofocus disabled readonly>
                            </div>
                            @error('slug')
                                <div class="mt-2 p-4 text-sm text-red-800 rounded-lg bg-red-50" role="alert">
                                    <span class="font-medium">{{ $message }}</span>
